...
const STORY: { title: string; year?: string; text: string; pre?: boolean; phase?: string }[] = [
  {
    ...
    year: '2016 и раньше',
    pre: true,
    phase: 'До 2022 · Егор учится работать с людьми',
  ...
  },
  {
    title: 'Отъезд',
    year: '2022',
    phase: 'С 2022 · Егор собирает людей',
    text: 'В 2022-м многие вдруг очень полюбили путешествовать. Егор тоже уехал, в Бангкок.',
  },
  {
    title: 'Неудача',
    year: '2023',
    text: 'Первое сообщество, которое Егор собрал вокруг своего кондо, развалилось.',
  },
  {
    title: 'Гипотеза',
    text: 'Егор не бросил. Он верил, что переезд даётся легче, если на новом месте тебя кто-то встречает.',
  },
  {
    title: 'Bangkok IT',
    text: 'Со второй попытки получилось: Егор создал Bangkok IT.',
  },
  { title: 'Работа и имя', year: '2024', text: 'Через сообщество Егор нашёл работу, его стали узнавать и звать на подкасты.' },
  {
    title: 'Сарафан',
    text: 'В Дананге к Егору подошёл незнакомец: «Мой друг с Кипра тебя знает». Ни того, ни другого Егор не знал, а сообщества на Кипре у него нет. Слух стал расходиться сам.',
  },
  {
    title: 'Рост',
    year: '2025',
...
const PHASE_CLASS = ['ph-me', 'ph-together', 'ph-people', 'ph-people']
