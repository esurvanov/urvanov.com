...
const STORY: { title: string; year?: string; text: string; pre?: boolean }[] = [
  ...
  },
  {
    title: 'Рост',
    year: '2025',
    text: 'Запустил ещё несколько сообществ, начал выступать в подкастах. Сомневался, нужно ли это в городах без экспатов. Москва и Питер показали, что нужно.',
  },
...
const VALUES = [
  { title: 'Польза сообществу', text: 'Рекламы и спонсоров нет. Зато здесь советуют друг другу проверенных людей и места.' },
