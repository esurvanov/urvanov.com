...
const STORY: { title: string; year?: string; text: string; pre?: boolean; phase?: string }[] = [
  ...
  },
  {
    ...
    text: 'В 2022-м многие вдруг очень полюбили путешествовать. Егор тоже уехал в Бангкок, и там появились мы: Bangkok IT.',
  },
  {
    title: 'Неудача',
    year: '2023',
  ...
  {
    title: 'Гипотеза',
    text: 'Мы не бросили. Верили, что переезд даётся легче, если на новом месте тебя кто-то встречает.',
  },
  { title: 'Работа и имя', year: '2024', text: 'Через сообщество люди начали находить работу, а нас стали узнавать.' },
  {
    title: 'Сарафан',
    text: 'В Дананге к Егору подошёл незнакомец: «Мой друг с Кипра тебя знает». Ни того, ни другого мы не знали, а сообщества на Кипре у нас нет.',
  },
  {
    title: 'Рост',
    year: '2025',
    text: 'Появились новые сообщества, мы начали выступать в подкастах. Сомневались, нужно ли это в городах без экспатов. Москва и Питер показали, что нужно.',
  },
