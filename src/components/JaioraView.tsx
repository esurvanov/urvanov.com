...
const STORY: { title: string; year?: string; text: string; pre?: boolean; phase?: string }[] = [
  ...
  },
  {
    ...
    text: 'В 2022-м многие вдруг очень полюбили путешествовать. Егор тоже уехал в Бангкок и создал там Bangkok IT.',
  },
  {
    title: 'Неудача',
    year: '2023',
    text: 'Не всё получалось сразу: сообщество, которое Егор собрал вокруг своего кондо, развалилось.',
  },
  {
    title: 'Гипотеза',
