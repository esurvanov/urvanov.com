...
const STORY: { title: string; year?: string; text: string; pre?: boolean; phase?: string }[] = [
  ...
  },
  {
    title: 'Bangkok IT',
    year: '2022',
    phase: 'С 2022 · Егор и сообщество',
    text: 'В 2022-м многие вдруг очень полюбили путешествовать. Егор тоже уехал в Бангкок и собрал первых из нас: так появился Bangkok IT.',
  },
  {
    title: 'Неудача',
    year: '2023',
    text: 'Не всё получалось сразу: сообщество вокруг одного кондо развалилось.',
  },
  {
    title: 'Гипотеза',
    text: 'Мы не бросили. Вместе с Егором верили, что переезд даётся легче, если на новом месте тебя кто-то встречает.',
  },
  { title: 'Работа и имя', year: '2024', text: 'Через сообщество люди начали находить работу. А Егора стали узнавать и звать на подкасты.' },
  {
    title: 'Сарафан',
    text: 'В Дананге к Егору подошёл незнакомец: «Мой друг с Кипра тебя знает». Ни того, ни другого мы не знали, а сообщества на Кипре у нас нет. Слух о нас стал расходиться сам.',
  },
  {
    title: 'Рост',
    year: '2025',
    phase: 'С 2025 · Сообщество само',
  ...
  },
  {
    title: 'Цель',
    year: '2027',
    text: '30 городов, 30 000 человек по всему миру и свой инструмент для нетворка: оффлайн-LinkedIn, который подскажет, с кем стоит встретиться рядом.',
  },
]
      ...
      <div className="s-wrap">
        ...
        <header className="s-jhero">
          ...
          <div>
            ...
            <p className="s-lead">Про мир, где живая встреча значит больше переписки. Здесь рады всем.</p>
          </div>
        </header>
